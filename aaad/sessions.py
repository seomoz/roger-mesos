...
REMEMBER_COOKIE_DURATION_SECONDS = int(os.getenv('REMEMBER_COOKIE_DURATION_SECONDS', 120))
...
def load_token(token):
    ...
    try:
        data = login_serializer.loads(token, max_age=REMEMBER_COOKIE_DURATION_SECONDS)
    except BadSignature, e:
        # bad signature, let's return None
        return None
